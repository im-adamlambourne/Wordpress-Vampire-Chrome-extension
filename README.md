...
3. Close Settings, then **Log in** in the popup (or **Sign in** in the editor overlay). Chrome opens the sign-in window. Sign in if needed (`admin@immediate.co.uk` / `password123` locally), then **Connect**.
